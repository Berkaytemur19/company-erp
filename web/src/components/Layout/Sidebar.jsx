      ...
      <div style={{ marginTop: 'auto' }}>
        <NavLink to="/profile"
          style={({ isActive }) => ({
            ...
            borderRadius: '8px', color: isActive ? '#f1f5f9' : '#64748b', textDecoration: 'none',
        ...
        <div style={{ padding: '12px', borderTop: '1px solid #1e293b', marginLeft: '-12px', marginRight: '-12px', marginTop: '8px' }}>
